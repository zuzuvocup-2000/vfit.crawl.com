...
class Media extends FrontendController{
    ...
    public function index($id = 0, $page = 1){
        ...
        $this->data['object'] = $this->AutoloadModel->_get_where([
            'select' => 'tb1.id,tb1.catalogueid, tb1.viewed, tb1.album, tb1.image, tb2.title, tb2.canonical, tb2.meta_title, tb2.meta_description,  tb2.description, tb2.content, tb1.created_at, tb2.iframe, tb5.fullname',
        ...
        //     $this->data['template'] = 'mobile/media/media/index';
