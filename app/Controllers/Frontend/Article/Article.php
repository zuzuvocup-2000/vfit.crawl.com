...
class Article extends FrontendController{
    ...
    public function index($id = 0, $page = 1){
        ...
        $this->data['object']['album_title'] = json_decode($this->data['object']['album_title']);
    ...
    //     ], TRUE);
        ...
        if(isset($this->data['object']['template'])){
