...
class Article extends BaseController{
	...
	public function update($id = 0){
		...
		$this->data[$this->data['module']] = $this->AutoloadModel->_get_where([
			'select' => 'tb1.link, tb4.title, tb4.canonical, tb4.description, tb4.content, tb4.meta_title, tb4.meta_description, tb1.catalogueid, tb1.image, tb1.album, tb1.publish, tb1.catalogue,tb1.video, tb4.router, tb4.icon, tb4.template, tb4.sub_title, tb4.sub_content,  tb4.album_title',
			'table' => $this->data['module'].' as tb1',
			'join' => [
					[
