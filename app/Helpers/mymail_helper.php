									...
									<table  cellpadding="0" cellspacing="0">
										...
										<tr>
											<td style="vertical-align: top;padding:0 0 20px 0;font-family:\'Segoe UI\' !important;font-size:15px;line-height:168%;"  class="content-block"  class="content-block">
												Đã có hoạt động đăng nhập không thành công vào tài khoản của bạn. Sử dụng mã xác thực dưới đây để chắc chắn rằng là bạn đang thực hiện thao tác này. Mã xác thực có hiệu lực 5 phút bắt đầu tính từ thời điểm gửi Email.
											</td>
										</tr>
										<tr>
