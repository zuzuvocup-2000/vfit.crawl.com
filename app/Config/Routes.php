...
// $routes->get('/en-30-account-bonus','Frontend\Homepage\Home::index');
$routes->get('/vi-30-mo-tai-khoan-nhan-thuong','Frontend\Homepage\Home::index_vi');
$routes->get('home.html','Frontend\Homepage\Home::index');
$routes->get('trang-chu.html','Frontend\Homepage\Home::index');
$routes->get('/en-ib-contest','Frontend\Homepage\Home::Original');
$routes->get('/vi-cuoc-thi-ib','Frontend\Homepage\Home::Original_vi');
...
$routes->match(['get','post'],'buy-lesson'.HTSUFFIX, 'Frontend\Product\Lesson::buy');
