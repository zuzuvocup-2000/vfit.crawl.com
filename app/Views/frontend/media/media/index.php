...
<div class="article-panel pt50 pb50">
...
<div class="wrap-relationship pb30">
    <div class="uk-container uk-container-center">
        <div class="article-realtionship uk-text-uppercase">Video liên quan</div>
        <ul class="menu_footer uk-list">
            ...
            ?>
                <li  class="menu-item menu-item-type-post_type menu-item-object-page mb15 "><a href="<?php echo $value['canonical'] ?>" title="<?php echo $value['title'] ?>" class="black"><?php echo $value['title'] ?></a></li>
            <?php }} ?>
        </ul>
    </div>
</div>
    ...
    <div class="uk-container uk-container-center">
        <div class="uk-grid uk-grid-medium uk-clearfix ">
            <div class="uk-width-1-1 uk-width-large-1-4">
                <h2 class="tieude_dangkyhocthu ">ĐĂNG KÝ HỌC THỬ  NIỀM VUI NHÂN ĐÔI</h2>
            </div>
