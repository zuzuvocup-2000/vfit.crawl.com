...
<form method="post" action="" class="form-horizontal box" >
	<div class="wrapper wrapper-content animated fadeInRight">
						...
						<div class="row">
							<div class="col-lg-6 mb15">
								<div class="form-row">
									...
									<?php  echo form_input('title_catalogue', validate_input(set_value('title_catalogue', (isset($slide_catalogue['title'])) ? $slide_catalogue['title'] : '')), 'class="form-control title" placeholder="" autocomplete="off"'); ?>
								</div>
							</div>
							<div class="col-lg-6 mb15">
								<div class="form-row">
									...
									<?php echo form_input('keyword_catalogue', validate_input(set_value('keyword_catalogue', (isset($slide_catalogue['keyword'])) ? $slide_catalogue['keyword'] : '')), 'class="form-control" '.((isset($slide_catalogue['keyword'])) ? 'readonly' : '').' placeholder="" autocomplete="off"'); ?>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form-row form-description">
									...
									<?php echo form_textarea('description_catalogue', htmlspecialchars_decode(html_entity_decode(set_value('description_catalogue', (isset($slide_catalogue['description'])) ? $slide_catalogue['description'] : ''))), 'class="form-control ck-editor" id="description" placeholder="" autocomplete="off"');?>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="col-lg-4">
			<div class="ibox mb20">
				<div class="ibox-title">
					<h5><?php echo translate('cms_lang.slide.slide_display', $language) ?> </h5>
				</div>
				<div class="ibox-content">
					<div class="row">
						<div class="col-lg-12">
							<div class="form-row">
								<div class="text-warning mb15"><?php echo translate('cms_lang.slide.slide_display1', $language) ?></div>
								<div class="block clearfix">
									<div class="i-checks mr30" style="width:100%;">
										<span style="color:#000;" class="uk-flex uk-flex-middle">
											...
											<label for="publish" style="margin:0;cursor:pointer;"><?php echo translate('cms_lang.slide.Selection3', $language) ?></label>
										</span>
									</div>
								</div>
								<div class="block clearfix">
									<div class="i-checks" style="width:100%;">
										<span style="color:#000;" class="uk-flex uk-flex-middle">
											...
											<label for="no-publish" style="margin:0;cursor:pointer;"><?php echo translate('cms_lang.slide.Selection4', $language) ?></label>
										</span>
									</div>
								</div>
							</div>
				...
				<div class="uk-grid uk-grid-medium uk-clearfix">
					<div class="uk-width-large-1-2">
						<div class="thumbnail-image video-image">
							<div class="va-thumb-1-1" style="display: none;">
