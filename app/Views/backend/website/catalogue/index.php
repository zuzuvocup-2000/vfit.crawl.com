                        ...
                        <div class="uk-flex uk-flex-middle uk-flex-space-between mb20">
                            ...
                            <div class="toolbox">
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    ...
                                    <div class="uk-button">
                                        <a href="<?php echo base_url('backend/article/catalogue/create') ?>" class="btn btn-danger btn-sm"><i class="fa fa-plus mr10"></i>  <?php echo translate('cms_lang.post_catalogue.postcat_add', $language) ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
