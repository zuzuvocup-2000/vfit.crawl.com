	...
	<div class="wrapper wrapper-content animated fadeInRight">
		...
		<div class="row">
			...
			<div class="col-lg-4">
                ...
                <div class="ibox mb20">
					<div class="ibox-title uk-flex-middle uk-flex uk-flex-space-between">
						<h5 class="choose-image" style="cursor: pointer;margin:0;">Link bài viết </h5>
						<a href="" title="" data-target="image" class="uploadIcon">Upload hình ảnh</a>
					</div>
					<div class="ibox-content">
						<div class="form-row mb15">
							<label>Link</label>
							<?php echo form_input('link', htmlspecialchars_decode(set_value('link', (isset($article['link'])) ? $article['link'] : '')), 'class="form-control" placeholder="" autocomplete="off" data-flag="0" ');?>
						</div>
				...
				<div class="ibox mb20" style="display:none">
					...
					<div class="ibox-content">
						<div class="form-row">
							<div class="text-danger">Lưu ý: Chỉ dành cho lập trình viên</div>
							<?php echo form_input('template', set_value('template', (isset($article['template']) && $article['template'] != '') ? $article['template'] : 'frontend/article/article/index'), 'class="form-control router-display"  placeholder="" autocomplete="off" data-flag="0" ');?>
						</div>
					</div>
				</div>
				<div class="ibox mb20" style="display:none">
