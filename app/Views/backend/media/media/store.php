						...
						<div class="row mb15">
							<div class="col-lg-12">
								<div class="form-row ">
									<div class="uk-flex uk-flex-middle uk-flex-space-between">
										<label class="control-label text-left">
											<span><?php echo translate('cms_lang.media.media_link', $language) ?></span>
										</label>
									</div>
									...
									<div class="form-row">
										...
										<div class="outer">
											<div class="uk-flex uk-flex-middle">
												...
												<?php echo form_hidden('original_canonical', htmlspecialchars_decode(html_entity_decode(set_value('canonical', (isset($media['canonical'])) ? $media['canonical'] : ''))), 'class="form-control canonical" placeholder="" autocomplete="off"');?>
