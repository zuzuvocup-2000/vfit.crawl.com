...
<div class="row wrapper border-bottom white-bg page-heading">
   <div class="col-lg-8">
      <h2><?php echo translate('cms_lang.media.media_title', $language) ?></h2>
      <ol class="breadcrumb" style="margin-bottom:10px;">
         ...
         <li class="active"><strong><?php echo translate('cms_lang.media.media_title', $language) ?></strong></li>
      </ol>
   </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><?php echo translate('cms_lang.media.media_title', $language) ?> </h5>
                        ...
                        <div class="uk-flex uk-flex-middle uk-flex-space-between mb20">
                            ...
                            <div class="toolbox">
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    ...
                                    <div class="uk-button">
                                        <a href="<?php echo base_url('backend/media/media/create') ?>" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> <?php echo translate('cms_lang.media.media_add', $language) ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
