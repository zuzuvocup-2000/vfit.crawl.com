...
<div class="row wrapper border-bottom white-bg page-heading">
   <div class="col-lg-8">
      ...
      <ol class="breadcrumb" style="margin-bottom:10px;">
         ...
         <li class="active"><strong>Quản lý Bài học</strong></li>
      </ol>
   </div>
</div>
                        ...
                        <div class="uk-flex uk-flex-middle uk-flex-space-between mb20">
                            ...
                            <div class="toolbox">
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    ...
                                    <div class="uk-button">
                                        <a href="<?php echo base_url('backend/product/lesson/create') ?>" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> Thêm Bài học mới</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="width:150px;">Tác giả</th>
                        ...
                        <tbody>
                            ...
                            <?php foreach($lessonList as $key => $val){ ?>
                            ...
                            <tr id="post-<?php echo $val['id']; ?>" data-id="<?php echo $val['id']; ?>">
                                ...
                                <td>
                                    <div class="uk-flex uk-flex-middle">
                                        ...
                                        <div class="main-info">
                                            <div class="title"><a class="maintitle" href="<?php echo site_url('backend/product/lesson/update/'.$val['id']); ?>" title=""><?php echo $val['article_title']; ?> (<?php echo $val['viewed']; ?>)</a></div>
                                            <div class="catalogue" style="font-size:10px">
                                                <span style="color:#f00000;">Khóa học: </span>
                                                ...
                                                <?php if(isset($cat_list) && is_array($cat_list) && count($cat_list)){ foreach($cat_list as $keyCat => $valCat){ ?>
                                                    <a class="" style="color:#333;" href="<?php echo site_url('backend/product/lesson/index?catalogueid='.$valCat['id']); ?>" title=""><?php echo $valCat['title'] ?></a><?php echo ($keyCat + 1 < count($cat_list)) ? ',' : '' ?>
                                                <?php }} ?>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <td class="text-center text-primary"><?php echo $val['author']; ?></td>
                                ...
                                <td class="text-center">
                                    <a type="button" href="<?php echo base_url('backend/product/lesson/update/'.$val['id']) ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                    <a type="button" href="<?php echo base_url('backend/product/lesson/delete/'.$val['id']) ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php }}else{ ?>
                                <tr>
