...
<div class="row wrapper border-bottom white-bg page-heading">
   <div class="col-lg-8">
      ...
      <ol class="breadcrumb" style="margin-bottom:10px;">
         ...
         <li class="active"><strong>Quản lý Khóa học</strong></li>
      </ol>
   </div>
</div>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title uk-flex uk-flex-middle uk-flex-space-between">
                    <div class="uk-flex uk-flex-middle">
                        <h5 class="mb0 ">Quản lý Khóa học </h5>
                        <div class="uk-button ml20">
                            <a href="<?php echo base_url('backend/product/catalogue/index') ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> QL Nhóm Khóa học</a>
                        </div>
                    </div>
                    <div class="ibox-tools">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li><a href="#" class="status" data-value="0" data-field="publish" data-module="<?php echo $module; ?>" title="Cập nhật trạng thái Khóa học">Deactive Khóa học</a>
                            </li>
                            <li><a href="#" class="status" data-value="1" data-field="publish" data-module="<?php echo $module; ?>" data-title="Cập nhật trạng thái Khóa học">Active Khóa học</a>
                            </li>
                        </ul>
                        <a class="close-link">
                ...
                <div class="ibox-content">
                        ...
                        <div class="uk-flex uk-flex-middle uk-flex-space-between mb20">
                            ...
                            <div class="toolbox">
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    ...
                                    <div class="uk-button">
                                        <a href="<?php echo base_url('backend/product/product/create') ?>" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> Thêm Khóa học Mới</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr>
                            ...
                            <th style="width:80px;" class="text-center">Trending</th>
                        ...
                        <tbody>
                            ...
                            <tr id="post-<?php echo $val['id']; ?>" data-id="<?php echo $val['id']; ?>">
                                ...
                                <?php }} ?>
                                <td class="text-center publishonoffswitch" data-field="featured" data-module="<?php echo $module; ?>" data-where="id">
                                    <div class="switch">
                                        <div class="onoffswitch">
                                            <input type="checkbox" class="onoffswitch-checkbox publish" data-id="<?php echo $val['id'] ?>" id="featured-<?php echo $val['id'] ?>" <?php echo ($val['featured'] == 1 ? 'checked' : '') ?>>
                                            <label class="onoffswitch-label" for="featured-<?php echo $val['id'] ?>">
                                ...
                                <td class="text-center publishonoffswitch" data-field="trending" data-module="<?php echo $module; ?>" data-where="id">
                                    <div class="switch">
                                        <div class="onoffswitch">
                                            <input type="checkbox" class="onoffswitch-checkbox publish" data-id="<?php echo $val['id'] ?>" id="trending-<?php echo $val['id'] ?>" <?php echo ($val['trending'] == 1 ? 'checked' : '') ?>>
                                            <label class="onoffswitch-label" for="trending-<?php echo $val['id'] ?>">
                                                <span class="onoffswitch-inner"></span>
                                                <span class="onoffswitch-switch"></span>
                                            </label>
                                        </div>
                                ...
                                <td class="text-center">
                                    ...
                                    /*<a type="button" data-toggle="modal" data-target="#add_combo" href="" class="btn btn-success add-combo-modal" data-id="<?php echo $val['id'] ?>" data-title="<?php echo $val['product_title'] ?>" data-module="<?php echo $module ?>"><i class="fa fa-ticket" aria-hidden="true"></i></a>*/
                                     ...
                                     ?>
                                     <a type="button" href="" data-toggle="modal" data-target="#open-user" class="btn btn-success open-modal-code"><i class="fa fa-user-plus" aria-hidden="true"></i></a>
...
<div id="open-user" class="modal fade va-general">  
      <div class="modal-dialog" style="width: 700px;">  
           <div class="modal-content">  
                <div class="modal-header">
                    <div class="uk-flex uk-flex-space-between uk-flex-middle" >
                        <h4 class="modal-title">Tạo code cho khách hàng</h4>  
                        <button type="button" class="close" data-dismiss="modal">&times;</button>  
                    </div>  
                </div>  
                <div class="modal-body">  
                    <table class="list-code-user-table  table table-striped table-bordered table-hover dataTables-example">
                        <thead>
                            <tr>
                                <td class="text-center" style="width: 35px;">STT</td>
                                <td class="text-center" style="width: 35px;">ID</td>
                                <td style="width: 250px">Tài khoản</td>
                                <td class="text-center">Code</td>
                            </tr>
                        </thead>
                        <tbody class="list-code-user">
                            
                        </tbody>
                    </table>
                    <form method="post" class="uk-clearfix form-code-lesson mt20">  
                        <div class="uk-grid uk-grid-small uk-grid-width-1-2 uk-clearfix">
                            <div class="wrap-grid">
                                <label class="mb10">Email</label>  
                                <?php echo form_dropdown('memberid', $member_list, '', 'class="form-control m-b select2 id-member-code mr10" style="width:150px;"');?>
                            </div>
                            <div class="wrap-grid">
                                <div class="va-input-general mb15" style="position:relative">
                                    <label class="mb10">Code</label>  
                                    <input type="text" name="code" class="form-control random-input" style="padding-right: 80px;" />
                                    <button onclick="make_random();return false;" class="btn btn-primary" style="position: absolute;height: 32px; bottom: 0; right: 0;">Random</button>  
                                </div>
                            </div>  
                        </div>
                        <button class="btn btn-success btn-create-code float-right mt10" data-productid="">Thêm mới  </button>
                    </form>  
                </div>   
           </div>  
      </div>  
 ...
 <div id="add_combo" class="modal fade va-general">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">
                    <div class="uk-flex uk-flex-space-between uk-flex-middle" >
                        <h4 class="modal-title">Tạo combo cho Khóa học (Tổng số: <span class="count-combo">5</span> Combo) </h4>  
                        <button type="button" class="close" data-dismiss="modal">&times;</button>  
                    </div>  
                </div>  
                <div class="modal-body">  
