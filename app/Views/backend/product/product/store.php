	...
	<div class="wrapper wrapper-content animated fadeInRight">
		...
		<div class="row">
			<div class="col-lg-8 clearfix">
							...
							<div class="col-lg-12">
								<div class="form-row">
									<label class="control-label text-left">
										<span>Tiêu đề Khóa học <b class="text-danger">(*)</b></span>
									</label>
				...
				<!-- Thông tin giá bán buôn của Khóa học -->
				<?php echo view('backend/product/product/common/wholesale') ?>

				<!-- Thông tin phần thuộc tính của Khóa học -->
				...
				<div class="ibox ibox-seo mb20">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-lg-12">
								<?php
									$metaTitle = (isset($_POST['meta_title'])) ? $_POST['meta_title'] : ((isset($product['meta_title']) && $product['meta_title'] != '') ? $product['meta_title'] : 'Bạn chưa nhập tiêu đề SEO cho Khóa học') ;
									...
									$metaDescription = (isset($_POST['meta_description'])) ? $_POST['meta_description'] : ((isset($product['meta_description']) && $product['meta_description'] != '') ? $product['meta_description'] : 'Bạn Chưa nhập mô tả SEO cho Khóa học') ;
								?>
								<div class="google">
			...
			<div class="col-lg-4">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-lg-12">
								...
								<div class="form-row mt20">
									<label class="control-label text-left">
										<span>Chọn thời gian hết hạn Khóa học</span>
									</label>
									<div class="form-row">
				...
				<div class="ibox mb20" style="display:none">
					<div class="ibox-title uk-flex-middle uk-flex uk-flex-space-between">
						<h5 class="choose-image" style="cursor: pointer;margin:0;">QR code </h5>
				...
				<div class="ibox mb20">
					<div class="ibox-title uk-flex-middle uk-flex uk-flex-space-between">
						<h5 class="choose-image" style="cursor: pointer;margin:0;">Tác giả </h5>
						<a href="" title="" data-target="image" class="uploadIcon">Upload hình ảnh</a>
					</div>
					<div class="ibox-content">
						<div class="form-row mb15">
							<label>Tên tác giả</label>
							<?php echo form_input('author', htmlspecialchars_decode(set_value('author', (isset($product['author'])) ? $product['author'] : '')), 'class="form-control" placeholder="" autocomplete="off" data-flag="0" ');?>
						</div>
						<div class="form-row mb15">
							<label>Chữ ký</label>
							<?php echo form_input('author_image', htmlspecialchars_decode(set_value('author_image', (isset($product['author_image'])) ? $product['author_image'] : '')), 'class="form-control  icon-display" placeholder="" autocomplete="off" data-flag="0" ');?>
						</div>

						<div class="form-row ">
							<label>Tổng thời lượng khóa học</label>
							<?php echo form_input('time', htmlspecialchars_decode(set_value('time', (isset($product['time'])) ? $product['time'] : '')), 'class="form-control  " placeholder="" autocomplete="off" data-flag="0" ');?>
						</div>
                ...
                <div class="ibox mb20">
                    <div class="ibox-title">Video Trailer</div>
                    <div class="ibox-content">
                        <div class="row">
							<div class="col-lg-12">
								<div class="form-row form-description">
                ...
                <div class="ibox mb20">
                    <div class="ibox-title">Video Sample</div>
                    <div class="ibox-content">
                        <div class="row">
							<div class="col-lg-12">
								<div class="form-row form-description">
									<?php echo form_textarea('video_2', htmlspecialchars_decode(html_entity_decode(set_value('video_2', (isset($product['video_2'])) ? $product['video_2'] : ''))), 'class="form-control" id="video_2" placeholder="" autocomplete="off"');?>
								</div>
							</div>
						</div>
                    </div>
           ...
           <div class="modal-content">
                <div class="modal-header">
                    <div class="uk-flex uk-flex-space-between uk-flex-middle" >
                       <h4 class="modal-title">Tạo Thương hiệu mới cho Khóa học</h4>
...
<div class="modal fade modal_version" id="openModalDetail">
  	<div class="modal-dialog" role="document">
	    <div class="modal-content">
	      	<div class="modal-header ">
	      		<div class="uk-flex uk-flex-middle uk-flex-space-between">
		        	<h5 class="modal-title" id="exampleModalLabel">Chỉnh sửa chi tiết phiên bản Khóa học</h5>
