							...
							<div class="col-lg-6">
								<div class="form-row">
									<label class="control-label text-left">
										<span>Tên Thương hiệu <b class="text-danger">(*)</b></span>
									</label>
									<?php echo form_input('title', validate_input(set_value('title', (isset($brand['title'])) ? $brand['title'] : '')), 'class="form-control title" placeholder="" id="title" autocomplete="off"'); ?>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-row">
									<label class="control-label text-left">
										<span>Nhãn hiệu<b class="text-danger">(*)</b></span>
									</label>
									<?php echo form_input('keyword', validate_input(set_value('keyword', (isset($brand['keyword'])) ? $brand['keyword'] : '')), 'class="form-control keyword" placeholder="" id="keyword" autocomplete="off"'); ?>
								</div>
							</div>
						</div>
						<div class="row mb15">
							<div class="col-lg-12">
								<div class="form-row">
									...
									<?php echo form_input('slogan', validate_input(set_value('slogan', (isset($brand['slogan'])) ? $brand['slogan'] : '')), 'class="form-control slogan" placeholder="" id="slogan" autocomplete="off"'); ?>
								</div>
							</div>
						</div>
						<div class="row mb15">
							<div class="col-lg-12">
								<div class="form-row form-description">
									...
									<?php echo form_textarea('description', htmlspecialchars_decode(html_entity_decode(set_value('description', (isset($brand['description'])) ? $brand['description'] : ''))), 'class="form-control ck-editor" id="description" placeholder="" autocomplete="off"');?>
						...
						<div class="row mb15">
							<div class="col-lg-12">
								<div class="form-row">
									...
									<?php echo form_textarea('content', htmlspecialchars_decode(html_entity_decode(set_value('content', (isset($brand['content'])) ? $brand['content'] : ''))), 'class="form-control ck-editor" id="content" placeholder="" autocomplete="off"');?>
					...
					<div class="ibox-content">
						<?php
							if(isset($_POST['album'])){
								...
								$album = json_decode($brand['album'], TRUE);
							}
				...
				<div class="ibox ibox-seo mb20">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-lg-12">
								<?php  
									$metaTitle = (isset($_POST['meta_title'])) ? $_POST['meta_title'] : ((isset($brand['meta_title']) && $brand['meta_title'] != '') ? $brand['meta_title'] : 'Bạn chưa nhập tiêu đề SEO cho Thương hiệu') ;
									$googleLink = (isset($_POST['canonical'])) ? $_POST['canonical'] : ((isset($brand['canonical']) && $brand['canonical'] != '') ? BASE_URL.$brand['canonical'].HTSUFFIX : BASE_URL.'duong-dan-website'.HTSUFFIX) ;
									$metaDescription = (isset($_POST['meta_description'])) ? $_POST['meta_description'] : ((isset($brand['meta_description']) && $brand['meta_description'] != '') ? $brand['meta_description'] : 'Bạn Chưa nhập mô tả SEO cho Thương hiệu') ;
								?>
								<div class="google">
							...
							<div class="row mb15">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<?php echo form_input('meta_title', htmlspecialchars_decode(html_entity_decode(set_value('meta_title', (isset($brand['meta_title'])) ? $brand['meta_title'] : ''))), 'class="form-control meta-title" placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
							<div class="row mb15">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<?php echo form_textarea('meta_description', set_value('meta_description', (isset($brand['meta_description'])) ? $brand['meta_description'] : ''), 'class="form-control meta-description" id="seoDescription" placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
							<div class="row mb15">
									...
									<div class="form-row">
										...
										<div class="outer">
											<div class="uk-flex uk-flex-middle">
												...
												<?php echo form_input('canonical', htmlspecialchars_decode(html_entity_decode(set_value('canonical', (isset($brand['canonical'])) ? $brand['canonical'] : ''))), 'class="form-control canonical" placeholder="" autocomplete="off" data-flag="0" ');?>
												<?php echo form_hidden('original_canonical', htmlspecialchars_decode(html_entity_decode(set_value('canonical', (isset($brand['canonical'])) ? $brand['canonical'] : ''))), 'class="form-control canonical" placeholder="" autocomplete="off"');?>
			...
			<div class="col-lg-4">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-lg-12">
								...
								<div class="form-row">
									<?php echo form_dropdown('catalogueid', $dropdown, set_value('catalogueid', (isset($brand['catalogueid'])) ? $brand['catalogueid'] : ''), 'class="form-control m-b select2"');?>
								</div>
								<script>
				...
				<div class="ibox mb20">
					<div class="ibox-title uk-flex-space-between uk-flex uk-flex-middle">
						<h5 class="choose-image" style="cursor: pointer;margin:0;">Logo</h5>
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-lg-12">
								<div class="form-row">
									<div class="avatar" style="cursor: pointer;"><img src="<?php echo (isset($_POST['image'])) ? $_POST['image'] : ((isset($brand['image']) && $brand['image'] != '') ? $brand['image'] : 'public/not-found.png') ?>" class="img-thumbnail" alt=""></div>
									<?php echo form_input('image', htmlspecialchars_decode(html_entity_decode(set_value('image', (isset($brand['image'])) ? $brand['image'] : ''))), 'class="form-control " placeholder="Đường dẫn của ảnh"  id="imageTxt"  autocomplete="off" style="display:none;" ');?>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="form-row">
									...
									<div class="block clearfix">
										<div class="i-checks mr30" style="width:100%;">
											<span style="color:#000;" class="uk-flex uk-flex-middle"> 
												<?php echo form_radio('publish', set_value('publish', 1), ((isset($_POST['publish']) && $_POST['publish'] == 1 || (isset($brand['publish']) && $brand['publish'] == 1)) ? true : (!isset($_POST['publish'])) ? true : false),'class=""  id="publish"  style="margin-top:0;margin-right:10px;" '); ?>
									...
									<div class="block clearfix">
										<div class="i-checks" style="width:100%;">
											<span style="color:#000;" class="uk-flex uk-flex-middle"> 
												<?php echo form_radio('publish', set_value('publish', 0), ((isset($_POST['publish']) && $_POST['publish'] == 0 || (isset($brand['publish']) && $brand['publish'] == 0)) ? true : false),'class=""   id="no-publish" style="margin-top:0;margin-right:10px;" '); ?>
