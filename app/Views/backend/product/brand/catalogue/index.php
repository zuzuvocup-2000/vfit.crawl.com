...
<div class="row wrapper border-bottom white-bg page-heading">
   <div class="col-lg-8">
      <h2>Quản Lý Nhóm Thương hiệu</h2>
      <ol class="breadcrumb" style="margin-bottom:10px;">
         <li>
            <a href="<?php echo base_url('backend/dashboard/dashboard/index') ?>">Home</a>
         </li>
         <li class="active"><strong>Quản lý Nhóm Thương hiệu</strong></li>
      </ol>
   </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Quản lý Nhóm Thương hiệu </h5>
                ...
                <div class="ibox-content">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tbody>
                            ...
                            <?php foreach($brandCatalogueList as $key => $val){ ?>
                            <?php  
                            ...
                            <tr id="post-<?php echo $val['id']; ?>" data-id="<?php echo $val['id']; ?>">
                                ...
                                <td <?php echo ($val['level'] == 1) ? 'class="text-success text-bold"' : '' ?>>
                                    <a href="<?php echo base_url('backend/product/brand/catalogue/update/'.$val['id'].'') ?>">
                                ...
                                <td class="text-center">
                                    <a type="button" href="<?php echo base_url('backend/product/brand/catalogue/update/'.$val['id']) ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                    <a type="button" href="<?php echo base_url('backend/product/brand/catalogue/delete/'.$val['id']) ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php }}else{ ?>
                                <tr>
