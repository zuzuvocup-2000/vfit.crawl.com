<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		<h2>Xóa Nhóm Thương hiệu: <?php echo $brand_catalogue['title'] ?></h2>
		<ol class="breadcrumb">
			<li>
				<a href="<?php echo site_url('admin'); ?>">Home</a>
			</li>
			<li class="active"><strong>Xóa Nhóm Thương hiệu</strong></li>
		</ol>
	</div>
</div>
			...
			<div class="col-lg-5">
				<div class="panel-head">
					...
					<div class="panel-description">
						...
						<div><span class="text-danger">Khi xóa Nhóm Thương hiệu, thì Nhóm Thương hiệu này sẽ không thể truy cập và mất toàn bộ thông tin. Hãy chắc chắn bạn muốn thực hiện chức năng này!</span></div>
					</div>
				</div>
			</div>
			<div class="col-lg-7">
							...
							<div class="col-lg-12">
								<div class="form-row">
									<label class="control-label text-left">
										<span>Nhóm Thương hiệu <b class="text-danger">(*)</b></span>
									</label>
