						...
						<div class="row mb15">
							<div class="col-lg-12">
								<div class="form-row">
									...
									<?php echo form_input('title', validate_input(set_value('title', (isset($article_catalogue['title'])) ? $article_catalogue['title'] : '')), 'class="form-control '.(($method == 'create') ? 'title' : '').'"  placeholder="" id="title" autocomplete="off"'); ?>
								</div>
							</div>
						</div>
						<div class="row mb15">
							<div class="col-lg-12">
								<div class="form-row form-description">
									...
									<?php echo form_textarea('description', htmlspecialchars_decode(html_entity_decode(set_value('description', (isset($article_catalogue['description'])) ? $article_catalogue['description'] : ''))), 'class="form-control ck-editor" id="description" placeholder="" autocomplete="off"');?>
						...
						<div class="row mb15">
							<div class="col-lg-12">
								<div class="form-row">
									...
									<?php echo form_textarea('content', htmlspecialchars_decode(html_entity_decode(set_value('content', (isset($article_catalogue['content'])) ? $article_catalogue['content'] : ''))), 'class="form-control ck-editor" id="content" placeholder="" autocomplete="off"');?>
					...
					<div class="ibox-content">
						<?php
							if(isset($_POST['album'])){
								$album = $_POST['album'];
							}else if(isset($article_catalogue)){
								$album = json_decode($article_catalogue['album'], TRUE);
							}
						 ?>
						<div class="row">
							<div class="col-lg-12">
				...
				<div class="ibox ibox-seo mb20">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-lg-12">
								<?php  
									$metaTitle = (isset($_POST['meta_title'])) ? $_POST['meta_title'] : ((isset($article_catalogue['meta_title']) && $article_catalogue['meta_title'] != '') ? $article_catalogue['meta_title'] : translate('cms_lang.post_catalogue.postcat_seo_validate_title', $language)) ;
									$googleLink = (isset($_POST['canonical'])) ? $_POST['canonical'] : ((isset($article_catalogue['canonical']) && $article_catalogue['canonical'] != '') ? BASE_URL.$article_catalogue['canonical'].HTSUFFIX : BASE_URL.'duong-dan-website'.HTSUFFIX) ;
									$metaDescription = (isset($_POST['meta_description'])) ? $_POST['meta_description'] : ((isset($article_catalogue['meta_description']) && $article_catalogue['meta_description'] != '') ? $article_catalogue['meta_description'] : translate('cms_lang.post_catalogue.postcat_seo_validate_description', $language)) ;
								?>
								<div class="google">
							...
							<div class="row mb15">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<?php echo form_input('meta_title', htmlspecialchars_decode(html_entity_decode(set_value('meta_title', (isset($article_catalogue['meta_title'])) ? $article_catalogue['meta_title'] : ''))), 'class="form-control meta-title" placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
							<div class="row mb15">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<?php echo form_textarea('meta_description', set_value('meta_description', (isset($article_catalogue['meta_description'])) ? $article_catalogue['meta_description'] : ''), 'class="form-control meta-description" id="seoDescription" placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
							<div class="row mb15">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-lg-12">
								...
								<div class="form-row">
									<?php echo form_dropdown('parentid', $dropdown, set_value('parentid', (isset($article_catalogue['parentid'])) ? $article_catalogue['parentid'] : ''), 'class="form-control m-b '.($method == 'create' ? $class : '').' select2" data-module="article_catalogue"'); ?>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="ibox mb20">
					...
					<div class="ibox-content">
						<div class="form-row">
							...
							<?php echo form_input('template', set_value('template', (isset($article_catalogue['template']) && $article_catalogue['template'] != '') ? $article_catalogue['template'] : 'frontend/article/catalogue/index'), 'class="form-control router-display"  placeholder="" autocomplete="off" data-flag="0" ');?>
						</div>
					</div>
				</div>
				<div class="ibox mb20">
					...
					<div class="ibox-content">
						<div class="form-row">
							<div class="text-danger">Lưu ý: Chỉ dành cho lập trình viên</div>
							<?php echo form_input('router', set_value('router', (isset($article_catalogue['router']) && $article_catalogue['router'] != '') ? $article_catalogue['router'] : '\App\Controllers\Frontend\Article\Catalogue::index'), 'class="form-control router-display"  placeholder="" autocomplete="off" data-flag="0" ');?>
						</div>
					</div>
				</div>
				<div class="ibox mb20">
					...
					<div class="ibox-content">
						<div class="form-row">
							...
							<?php echo form_input('icon', htmlspecialchars_decode(set_value('icon', (isset($article_catalogue['icon'])) ? $article_catalogue['icon'] : '')), 'class="form-control icon-display" placeholder="" autocomplete="off" data-flag="0" ');?>
						</div>
					</div>
				</div>
				<div class="ibox mb20">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-lg-12">
								<div class="form-row">
									<div class="avatar" style="cursor: pointer;"><img src="<?php echo (isset($_POST['image'])) ? $_POST['image'] : ((isset($article_catalogue['image']) && $article_catalogue['image'] != '') ? $article_catalogue['image'] : 'public/not-found.png') ?>" class="img-thumbnail" alt=""></div>
									<?php echo form_input('image', htmlspecialchars_decode(html_entity_decode(set_value('image', (isset($article_catalogue['image'])) ? $article_catalogue['image'] : ''))), 'class="form-control " placeholder="Đường dẫn của ảnh"  id="imageTxt"  autocomplete="off" style="display:none;" ');?>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="form-row">
									...
									<div class="block clearfix">
										<div class="i-checks mr30" style="width:100%;">
											<span style="color:#000;" class="uk-flex uk-flex-middle"> 
												<?php echo form_radio('publish', set_value('publish', 1), ((isset($_POST['publish']) && $_POST['publish'] == 1 || (isset($article_catalogue['publish']) && $article_catalogue['publish'] == 1)) ? true : (!isset($_POST['publish'])) ? true : false),'class=""  id="publish"  style="margin-top:0;margin-right:10px;" '); ?>
									...
									<div class="block clearfix">
										<div class="i-checks" style="width:100%;">
											<span style="color:#000;" class="uk-flex uk-flex-middle"> 
												<?php echo form_radio('publish', set_value('publish', 0), ((isset($_POST['publish']) && $_POST['publish'] == 0 || (isset($article_catalogue['publish']) && $article_catalogue['publish'] == 0)) ? true : false),'class=""   id="no-publish" style="margin-top:0;margin-right:10px;" '); ?>
