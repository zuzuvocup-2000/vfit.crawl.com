        ...
        <div class="container">
            <div class='col-md-9 card mx-auto d-flex flex-row px-0'>
                ...
                <div class="card-body d-flex flex-column justify-content-center">
                    <h4 class="title text-center mt-4 pb-3 title-login">Xác nhận mã OTP</h4>
                    <form class='col-sm-10 col-12 mx-auto' action="" method="post" >
                        ...
                        <div class=''>
                            <input type="submit" class="btn  btn-outline-primary d-block w-100 " value='Xác nhận mã OTP'>
                        </div>
                    </form>
                </div>
            </div>
