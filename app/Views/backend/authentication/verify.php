...
<html lang="en">
    <head>
        ...
        <title>
            Xác nhận OTP | <?php echo NAME_PROJECT ?>
        </title>
        <!--     Fonts and icons     -->
                            ...
                            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                                <div class="card card-plain">
                                    <div class="card-header pb-0 text-start">
                                        <h4 class="font-weight-bolder">Xác nhận OTP</h4>
                                        <p class="mb-0">Nhập mã OTP đã được gửi vào Email của bạn</p>
                                    </div>
                                    <div class="card-body">
                                        <form action="" method="post" >
                                            <?php echo  (!empty($validate) && isset($validate)) ? '<div class="alert alert-danger">'.$validate.'</div>'  : '' ?>
                                            <div class="mb-3">
                                                <input type="text" name="otp" class="form-control form-control-lg" placeholder="Mã OTP..." value="<?php echo isset($_POST['otp']) ? $_POST['otp'] : ''  ?>" />
                                            </div>
                                            <div class="text-center">
                                                <button type="submit" onclick="$(this).html('<i class=\'fa fa-spinner fa-spin\'></i> Loading');$(this).attr('disabled','disabled');$(this).parents('form').submit();" class="btn btn-lg btn-primary btn-lg w-100 mt-2 mb-0">Xác nhận OTP</button>
                                            </div>
                                        </form>
                                    </div>
